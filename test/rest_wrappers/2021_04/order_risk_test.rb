...
class OrderRisk202104Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks/284138680.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks/284138680.json")
  end
  ...
  def test_4()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks/284138680.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks/284138680.json")
  end
  ...
  def test_5()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks/284138680.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/orders/450789469/risks/284138680.json")
  end
