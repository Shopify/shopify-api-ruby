...
class DraftOrder202104Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders.json")
  end
  ...
  def test_6()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders.json")
  end
  ...
  def test_7()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539.json")
  end
  ...
  def test_9()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539.json")
  end
  ...
  def test_10()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539.json")
  end
  ...
  def test_11()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/count.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/count.json")
  end
  ...
  def test_12()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539/send_invoice.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539/send_invoice.json")
  end
  ...
  def test_14()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539/complete.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539/complete.json")
  end
  ...
  def test_15()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539/complete.json?payment_pending=true")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-04/draft_orders/994118539/complete.json?payment_pending=true")
  end
