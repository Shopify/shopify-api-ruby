...
class ApplicationCharge202201Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges/675931192.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges/675931192.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges.json?since_id=556467234")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges.json?since_id=556467234")
  end
  ...
  def test_5()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2022-01/application_charges.json")
  end
