...
class CancellationRequest202107Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000778/cancellation_request.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000778/cancellation_request.json")
  end
  ...
  def test_2()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000779/cancellation_request/accept.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000779/cancellation_request/accept.json")
  end
  ...
  def test_3()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000780/cancellation_request/reject.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000780/cancellation_request/reject.json")
  end
