...
class Fulfillment202107Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments.json?since_id=255858046")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments.json?since_id=255858046")
  end
  ...
  def test_3()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments.json")
  end
  ...
  def test_15()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000798/fulfillments.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000798/fulfillments.json")
  end
  ...
  def test_16()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/count.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/count.json")
  end
  ...
  def test_17()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046.json")
  end
  ...
  def test_18()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046.json")
  end
  ...
  def test_19()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillments.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillments.json")
  end
  ...
  def test_21()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019883/update_tracking.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019883/update_tracking.json")
  end
  ...
  def test_22()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046/complete.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046/complete.json")
  end
  ...
  def test_23()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046/open.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046/open.json")
  end
  ...
  def test_24()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046/cancel.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments/255858046/cancel.json")
  end
  ...
  def test_25()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019884/cancel.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019884/cancel.json")
  end
