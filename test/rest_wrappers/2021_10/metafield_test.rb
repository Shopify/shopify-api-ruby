...
class Metafield202110Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields.json")
  end
  ...
  def test_5()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: { "metafield" => hash_including({namespace: "inventory", key: "warehouse", value: 25, type: "number_integer"}) }
      )
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields.json")
  end
  ...
  def test_8()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/count.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/count.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/845366454.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/845366454.json")
  end
  ...
  def test_12()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/845366454.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/845366454.json")
  end
  ...
  def test_14()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/845366454.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/products/632910392/metafields/845366454.json")
  end
