...
class StorefrontAccessToken202110Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/storefront_access_tokens.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/storefront_access_tokens.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/storefront_access_tokens.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/storefront_access_tokens.json")
  end
  ...
  def test_3()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/storefront_access_tokens/755357713.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/storefront_access_tokens/755357713.json")
  end
