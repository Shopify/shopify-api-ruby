...
class PriceRule202110Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules.json")
  end
  ...
  def test_6()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules.json")
  end
  ...
  def test_7()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/507328175.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/507328175.json")
  end
  ...
  def test_8()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/507328175.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/507328175.json")
  end
  ...
  def test_9()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/507328175.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/507328175.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/count.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/price_rules/count.json")
  end
