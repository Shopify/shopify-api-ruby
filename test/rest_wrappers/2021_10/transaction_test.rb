...
class Transaction202110Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/shopify_payments/balance/transactions.json?payout_id=623721858")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/2021-10/shopify_payments/balance/transactions.json?payout_id=623721858")
  end
