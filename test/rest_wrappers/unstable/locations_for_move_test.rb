...
class LocationsForMoveUnstableTest < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/fulfillment_orders/1046000781/locations_for_move.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/fulfillment_orders/1046000781/locations_for_move.json")
  end
