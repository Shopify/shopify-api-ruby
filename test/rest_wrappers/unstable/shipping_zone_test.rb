...
class ShippingZoneUnstableTest < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/shipping_zones.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/shipping_zones.json")
  end
