...
class AssetUnstableTest < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json")
  end
  ...
  def test_2()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json")
      .with(
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json")
  end
  ...
  def test_6()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
  end
  ...
  def test_7()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
  end
