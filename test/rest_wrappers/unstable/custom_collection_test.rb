...
class CustomCollectionUnstableTest < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json?since_id=841564295")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json?since_id=841564295")
  end
  ...
  def test_3()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json?product_id=632910392")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json?product_id=632910392")
  end
  ...
  def test_4()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json?ids=395646240%2C691652237%2C841564295")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json?ids=395646240%2C691652237%2C841564295")
  end
  ...
  def test_5()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/count.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/count.json")
  end
  ...
  def test_11()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/count.json?product_id=632910392")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/count.json?product_id=632910392")
  end
  ...
  def test_12()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/841564295.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/841564295.json")
  end
  ...
  def test_13()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/841564295.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/841564295.json")
  end
  ...
  def test_19()
    ...
    custom_collection.id = 841564295
    custom_collection.image = ""
    custom_collection.updated_at = "2022-01-06T16:05:39-05:00"
    custom_collection.title = "IPods"
  ...
  def test_21()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/841564295.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/custom_collections/841564295.json")
  end
