...
class SmartCollectionUnstableTest < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json")
      .with(
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json?since_id=482865238")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json?since_id=482865238")
  end
  ...
  def test_3()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json?product_id=632910392")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json?product_id=632910392")
  end
  ...
  def test_4()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json?ids=482865238%2C1063001360")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    ShopifyAPI::SmartCollection.all(
      session: @test_session,
      ids: "482865238,1063001360",
    )

    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json?ids=482865238%2C1063001360")
  end
  ...
  def test_5()
    stub_request(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json")
      .with(
    ...
    assert_requested(:post, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/count.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/count.json")
  end
  ...
  def test_11()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/count.json?product_id=632910392")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/count.json?product_id=632910392")
  end
  ...
  def test_12()
    stub_request(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:get, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json")
  end
  ...
  def test_13()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json")
  end
  ...
  def test_17()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: { "smart_collection" => hash_including({id: 482865238, image: "", updated_at: "2022-01-06T16:31:57-05:00", title: "Smart iPods", handle: "smart-ipods", body_html: "<p>The best selling ipod ever</p>", published_at: "2008-02-01T19:00:00-05:00", sort_order: "manual", template_suffix: nil, disjunctive: false, rules: [{column: "type", relation: "equals", condition: "Cult Products"}], published_scope: "web", admin_graphql_api_id: "gid://shopify/Collection/482865238"}) }
      )
      .to_return(status: 200, body: "{}", headers: {})
    ...
    smart_collection.id = 482865238
    smart_collection.image = ""
    smart_collection.updated_at = "2022-01-06T16:31:57-05:00"
  ...
  def test_19()
    stub_request(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json")
  end
  ...
  def test_20()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238/order.json?products%5B%5D=921728736&products%5B%5D=632910392")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238/order.json?products%5B%5D=921728736&products%5B%5D=632910392")
  end
  ...
  def test_21()
    stub_request(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238/order.json?sort_order=alpha-desc")
      .with(
        headers: {"Accept"=>"application/json", "X-Shopify-Access-Token"=>"this_is_a_test_token", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://this-is-a-test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238/order.json?sort_order=alpha-desc")
  end
