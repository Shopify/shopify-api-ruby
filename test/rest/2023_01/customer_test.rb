...
class Customer202301Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers.json?ids=207119551%2C1073339465")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers.json?ids=207119551%2C1073339465")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers.json?updated_at_min=2023-02-01+14%3A53%3A15")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers.json?updated_at_min=2023-02-01+14%3A53%3A15")
  end
  ...
  def test_26()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/count.json?updated_at_min=2023-02-01+14%3A47%3A31")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/count.json?updated_at_min=2023-02-01+14%3A47%3A31")
  end
  ...
  def test_27()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/count.json?created_at_min=2023-02-01+14%3A40%3A44")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/count.json?created_at_min=2023-02-01+14%3A40%3A44")
  end
