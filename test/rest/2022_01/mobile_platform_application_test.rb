...
class MobilePlatformApplication202201Test < Test::Unit::TestCase
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176008.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176008.json")
  end
  ...
  def test_5()
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176009.json")
  end
  ...
  def test_6()
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176010.json")
  end
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176011.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176011.json")
  end
