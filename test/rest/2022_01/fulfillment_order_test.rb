...
class FulfillmentOrder202201Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000778.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000778.json")
  end
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000779/cancel.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000779/cancel.json")
  end
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000782/close.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000782/close.json")
  end
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000783/move.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000783/move.json")
  end
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000785/open.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000785/open.json")
  end
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000786/reschedule.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000786/reschedule.json")
  end
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000787/hold.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000787/hold.json")
  end
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000789/release_hold.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/fulfillment_orders/1046000789/release_hold.json")
  end
