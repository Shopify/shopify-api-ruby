...
class ProductResourceFeedback202501Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2025-01/products/632910392/resource_feedback.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "resource_feedback" => hash_including({"state" => "requires_action", "messages" => ["Needs at least one image."], "resource_updated_at" => "2025-01-02T11:09:43-05:00", "feedback_generated_at" => "2025-01-02T16:22:23.605756Z"}) }
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2025-01/products/632910392/resource_feedback.json")
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2025-01/products/632910392/resource_feedback.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "resource_feedback" => hash_including({"state" => "success", "resource_updated_at" => "2025-01-02T11:09:43-05:00", "feedback_generated_at" => "2025-01-02T16:22:23.139254Z"}) }
      )
      .to_return(status: 200, body: JSON.generate({"resource_feedback" => {"created_at" => "2025-01-02T11:22:23-05:00", "updated_at" => "2025-01-02T11:22:23-05:00", "resource_id" => 632910392, "resource_type" => "Product", "resource_updated_at" => "2025-01-02T11:09:43-05:00", "messages" => [], "feedback_generated_at" => "2025-01-02T11:22:23-05:00", "state" => "success"}}), headers: {})
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-01/products/632910392/resource_feedback.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-01/products/632910392/resource_feedback.json")
