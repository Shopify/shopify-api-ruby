...
class MobilePlatformApplication202210Test < Test::Unit::TestCase
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-10/mobile_platform_applications/1066175999.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
  ...
  def test_6()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-10/mobile_platform_applications/1066176003.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-10/mobile_platform_applications/1066176003.json")
  end
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-10/mobile_platform_applications/1066176001.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-10/mobile_platform_applications/1066176001.json")
  end
