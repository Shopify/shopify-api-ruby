...
class Fulfillment202210Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000823/fulfillments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000823/fulfillments.json")
  end
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillments/1069019889/update_tracking.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillments/1069019889/update_tracking.json")
  end
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillments/1069019883/cancel.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillments/1069019883/cancel.json")
  end
