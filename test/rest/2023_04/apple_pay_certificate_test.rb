...
class ApplePayCertificate202304Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938275.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938275.json")
  ...
  def test_4()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938276.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938276.json")
