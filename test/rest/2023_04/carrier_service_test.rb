...
class CarrierService202304Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/carrier_services/1036895017.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-04/carrier_services/1036895017.json")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/carrier_services/1036895021.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/carrier_services/1036895021.json")
  ...
  def test_5()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/carrier_services/1036895020.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/carrier_services/1036895020.json")
