...
class Fulfillment202304Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillment_orders/1046001271/fulfillments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillment_orders/1046001271/fulfillments.json")
  ...
  def test_11()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillments/1069020390/update_tracking.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillments/1069020390/update_tracking.json")
  ...
  def test_12()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillments/1069020385/update_tracking.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillments/1069020385/update_tracking.json")
  ...
  def test_13()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillments/1069020388/cancel.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-04/fulfillments/1069020388/cancel.json")
