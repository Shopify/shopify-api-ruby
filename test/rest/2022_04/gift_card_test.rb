...
class GiftCard202204Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/gift_cards.json?status=enabled")
      ...
      .to_return(status: 200, body: JSON.generate({"gift_cards" => [{"id" => 766118925, "balance" => "25.00", "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T06:49:28-04:00", "currency" => "USD", "initial_value" => "50.00", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "customer_id" => nil, "note" => nil, "expires_on" => "2022-06-21", "template_suffix" => nil, "last_characters" => "0e0e", "order_id" => nil}, {"id" => 10274553, "balance" => "0.00", "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T06:49:28-04:00", "currency" => "USD", "initial_value" => "50.00", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "customer_id" => nil, "note" => nil, "expires_on" => nil, "template_suffix" => nil, "last_characters" => "0y0y", "order_id" => nil}]}), headers: {})
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/gift_cards.json")
      ...
      .to_return(status: 200, body: JSON.generate({"gift_cards" => [{"id" => 1035197676, "balance" => "100.00", "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T06:49:28-04:00", "currency" => "USD", "initial_value" => "100.00", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "customer_id" => nil, "note" => nil, "expires_on" => nil, "template_suffix" => nil, "last_characters" => "0d0d", "order_id" => nil}, {"id" => 766118925, "balance" => "25.00", "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T06:49:28-04:00", "currency" => "USD", "initial_value" => "50.00", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "customer_id" => nil, "note" => nil, "expires_on" => "2022-06-21", "template_suffix" => nil, "last_characters" => "0e0e", "order_id" => nil}, {"id" => 10274553, "balance" => "0.00", "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T06:49:28-04:00", "currency" => "USD", "initial_value" => "50.00", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "customer_id" => nil, "note" => nil, "expires_on" => nil, "template_suffix" => nil, "last_characters" => "0y0y", "order_id" => nil}]}), headers: {})
  ...
  def test_4()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/gift_cards/1035197676.json")
      ...
      .to_return(status: 200, body: JSON.generate({"gift_card" => {"expires_on" => "2020-01-01", "template_suffix" => nil, "initial_value" => "100.00", "balance" => "100.00", "customer_id" => nil, "id" => 1035197676, "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T11:31:05-04:00", "currency" => "USD", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "note" => nil, "last_characters" => "0d0d", "order_id" => nil}}), headers: {})
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/gift_cards/1035197676.json")
      ...
      .to_return(status: 200, body: JSON.generate({"gift_card" => {"note" => "Updating with a new note", "template_suffix" => nil, "initial_value" => "100.00", "balance" => "100.00", "customer_id" => nil, "id" => 1035197676, "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T11:31:02-04:00", "currency" => "USD", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "expires_on" => nil, "last_characters" => "0d0d", "order_id" => nil}}), headers: {})
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/gift_cards.json")
      ...
      .to_return(status: 200, body: JSON.generate({"gift_card" => {"id" => 1063936688, "balance" => "25.00", "created_at" => "2023-06-21T11:30:51-04:00", "updated_at" => "2023-06-21T11:30:51-04:00", "currency" => "USD", "initial_value" => "25.00", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => 755357713, "user_id" => nil, "customer_id" => nil, "note" => nil, "expires_on" => nil, "template_suffix" => nil, "last_characters" => "cdcd", "order_id" => nil, "code" => "9ba728cc4667cdcd"}}), headers: {})
  ...
  def test_10()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/gift_cards/1035197676/disable.json")
      ...
      .to_return(status: 200, body: JSON.generate({"gift_card" => {"disabled_at" => "2023-06-21T11:30:52-04:00", "template_suffix" => nil, "initial_value" => "100.00", "balance" => "100.00", "customer_id" => nil, "id" => 1035197676, "created_at" => "2023-06-21T06:49:28-04:00", "updated_at" => "2023-06-21T11:30:52-04:00", "currency" => "USD", "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "note" => nil, "expires_on" => nil, "last_characters" => "0d0d", "order_id" => nil}}), headers: {})
  ...
  def test_11()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/gift_cards/search.json?query=last_characters%3Amnop")
      ...
      .to_return(status: 200, body: JSON.generate({"gift_cards" => [{"id" => 1063936691, "balance" => "10.00", "created_at" => "2023-06-21T11:31:00-04:00", "updated_at" => "2023-06-21T11:31:00-04:00", "currency" => "USD", "initial_value" => "10.00", "disabled_at" => nil, "line_item_id" => nil, "api_client_id" => nil, "user_id" => nil, "customer_id" => nil, "note" => nil, "expires_on" => nil, "template_suffix" => nil, "last_characters" => "mnop", "order_id" => nil}]}), headers: {})
