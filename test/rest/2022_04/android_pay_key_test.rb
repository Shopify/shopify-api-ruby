...
class AndroidPayKey202204Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/android_pay_keys/964811895.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/android_pay_keys/964811895.json")
  end
