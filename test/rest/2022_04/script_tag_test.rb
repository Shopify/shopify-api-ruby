...
class ScriptTag202204Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/script_tags.json?src=https%3A%2F%2Fjs-aplenty.com%2Ffoo.js")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/script_tags.json?src=https%3A%2F%2Fjs-aplenty.com%2Ffoo.js")
  end
