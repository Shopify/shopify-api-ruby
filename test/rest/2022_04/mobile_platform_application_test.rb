...
class MobilePlatformApplication202204Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications.json")
      ...
      .to_return(status: 200, body: JSON.generate({"mobile_platform_applications" => [{"id" => 1066175996, "application_id" => "X1Y2.ca.domain.app", "platform" => "ios", "created_at" => "2023-01-03T12:42:47-05:00", "updated_at" => "2023-01-03T12:42:47-05:00", "sha256_cert_fingerprints" => [], "enabled_universal_or_app_links" => true, "enabled_shared_webcredentials" => true, "enabled_app_clips" => false, "app_clip_application_id" => nil}, {"id" => 1066175997, "application_id" => "com.example", "platform" => "android", "created_at" => "2023-01-03T12:42:47-05:00", "updated_at" => "2023-01-03T12:42:47-05:00", "sha256_cert_fingerprints" => ["14:6D:E9:83:C5:73:06:50:D8:EE:B9:95:2F:34:FC:64:16:A0:83:42:E6:1D:BE:A8:8A:04:96:B2:3F:CF:44:E5"], "enabled_universal_or_app_links" => true, "enabled_shared_webcredentials" => false, "enabled_app_clips" => false, "app_clip_application_id" => nil}]}), headers: {})
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications.json")
      ...
      .to_return(status: 200, body: JSON.generate({"mobile_platform_application" => {"id" => 1066176000, "application_id" => "X1Y2.ca.domain.app", "platform" => "ios", "created_at" => "2023-01-03T12:42:54-05:00", "updated_at" => "2023-01-03T12:42:54-05:00", "sha256_cert_fingerprints" => [], "enabled_universal_or_app_links" => true, "enabled_shared_webcredentials" => true, "enabled_app_clips" => false, "app_clip_application_id" => nil}}), headers: {})
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications/1066175998.json")
      ...
      .to_return(status: 200, body: JSON.generate({"mobile_platform_application" => {"id" => 1066175998, "application_id" => "X1Y2.ca.domain.app", "platform" => "ios", "created_at" => "2023-01-03T12:42:49-05:00", "updated_at" => "2023-01-03T12:42:49-05:00", "sha256_cert_fingerprints" => [], "enabled_universal_or_app_links" => true, "enabled_shared_webcredentials" => true, "enabled_app_clips" => false, "app_clip_application_id" => nil}}), headers: {})
  ...
  def test_5()
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications/1066175999.json")
  end
  ...
  def test_6()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications/1066176003.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "mobile_platform_application" => hash_including({"application_id" => "A1B2.ca.domain.app", "platform" => "ios", "created_at" => "2023-01-03T12:42:58-05:00", "updated_at" => "2023-01-03T12:42:58-05:00", "sha256_cert_fingerprints" => [], "enabled_universal_or_app_links" => true, "enabled_shared_webcredentials" => true, "enabled_app_clips" => false, "app_clip_application_id" => nil}) }
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications/1066176003.json")
  end
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications/1066176001.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/mobile_platform_applications/1066176001.json")
  end
