...
class CustomerSavedSearch202204Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/customer_saved_searches.json")
      ...
      .to_return(status: 200, body: JSON.generate({"customer_saved_searches" => [{"id" => 789629109, "name" => "Accepts Marketing", "created_at" => "2022-10-24T10:32:41-04:00", "updated_at" => "2022-10-24T10:32:41-04:00", "query" => "accepts_marketing:1"}, {"id" => 20610973, "name" => "Canadian Snowboarders", "created_at" => "2022-10-24T10:32:41-04:00", "updated_at" => "2022-10-24T10:32:41-04:00", "query" => "country:Canada"}, {"id" => 669439218, "name" => "Premier Customers", "created_at" => "2022-10-24T10:32:41-04:00", "updated_at" => "2022-10-24T10:32:41-04:00", "query" => "John Smith orders_count:>10 total_spent:>100.00"}]}), headers: {})
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/customer_saved_searches.json?since_id=20610973")
      ...
      .to_return(status: 200, body: JSON.generate({"customer_saved_searches" => [{"id" => 669439218, "name" => "Premier Customers", "created_at" => "2022-10-24T10:32:41-04:00", "updated_at" => "2022-10-24T10:32:41-04:00", "query" => "John Smith orders_count:>10 total_spent:>100.00"}, {"id" => 789629109, "name" => "Accepts Marketing", "created_at" => "2022-10-24T10:32:41-04:00", "updated_at" => "2022-10-24T10:32:41-04:00", "query" => "accepts_marketing:1"}]}), headers: {})
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/customer_saved_searches.json")
      ...
      .to_return(status: 200, body: JSON.generate({"customer_saved_search" => {"id" => 1068136102, "name" => "Spent more than $50", "created_at" => "2022-10-31T10:33:27-04:00", "updated_at" => "2022-10-31T10:33:27-04:00", "query" => "total_spent:>50"}}), headers: {})
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/customer_saved_searches.json")
      ...
      .to_return(status: 200, body: JSON.generate({"customer_saved_search" => {"id" => 1068136103, "name" => "Spent more than $50 and after 2013", "created_at" => "2022-10-31T10:33:49-04:00", "updated_at" => "2022-10-31T10:33:49-04:00", "query" => "total_spent:>50 order_date:>=2013-01-01"}}), headers: {})
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/customer_saved_searches/789629109.json")
      ...
      .to_return(status: 200, body: JSON.generate({"customer_saved_search" => {"id" => 789629109, "name" => "Accepts Marketing", "created_at" => "2022-10-24T10:32:41-04:00", "updated_at" => "2022-10-24T10:32:41-04:00", "query" => "accepts_marketing:1"}}), headers: {})
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/customer_saved_searches/789629109.json")
      ...
      .to_return(status: 200, body: JSON.generate({"customer_saved_search" => {"name" => "This Name Has Been Changed", "id" => 789629109, "created_at" => "2022-10-24T10:32:41-04:00", "updated_at" => "2022-10-31T10:33:35-04:00", "query" => "accepts_marketing:1"}}), headers: {})
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/customer_saved_searches/789629109/customers.json")
      ...
      .to_return(status: 200, body: JSON.generate({"customers" => [{"id" => 207119551, "email" => "bob.norman@mail.example.com", "accepts_marketing" => true, "created_at" => "2022-10-31T10:32:41-04:00", "updated_at" => "2022-10-31T10:33:36-04:00", "first_name" => "Bob", "last_name" => "Norman", "orders_count" => 1, "state" => "disabled", "total_spent" => "199.65", "last_order_id" => 450789469, "note" => nil, "verified_email" => true, "multipass_identifier" => nil, "tax_exempt" => false, "tags" => "", "last_order_name" => "#1001", "currency" => "USD", "phone" => "+16136120707", "addresses" => [{"id" => 207119551, "customer_id" => 207119551, "first_name" => nil, "last_name" => nil, "company" => nil, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "province" => "Kentucky", "country" => "United States", "zip" => "40202", "phone" => "555-625-1199", "name" => "", "province_code" => "KY", "country_code" => "US", "country_name" => "United States", "default" => true}], "accepts_marketing_updated_at" => "2022-10-31T10:33:36-04:00", "marketing_opt_in_level" => "single_opt_in", "tax_exemptions" => [], "sms_marketing_consent" => {"state" => "not_subscribed", "opt_in_level" => "single_opt_in", "consent_updated_at" => "2022-10-31T10:32:41-04:00", "consent_collected_from" => "OTHER"}, "admin_graphql_api_id" => "gid://shopify/Customer/207119551", "default_address" => {"id" => 207119551, "customer_id" => 207119551, "first_name" => nil, "last_name" => nil, "company" => nil, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "province" => "Kentucky", "country" => "United States", "zip" => "40202", "phone" => "555-625-1199", "name" => "", "province_code" => "KY", "country_code" => "US", "country_name" => "United States", "default" => true}}]}), headers: {})
