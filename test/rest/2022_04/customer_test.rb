...
class Customer202204Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/customers.json?updated_at_min=2022-04-04+17%3A02%3A13")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/customers.json?updated_at_min=2022-04-04+17%3A02%3A13")
  end
