...
class PriceRuleUnstableTest < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/price_rules.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/price_rules.json")
  end
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/price_rules.json")
      .with(
  ...
  def test_7()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/unstable/price_rules/507328175.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/unstable/price_rules/507328175.json")
  end
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/price_rules/507328175.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/unstable/price_rules/507328175.json")
  end
  ...
  def test_9()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/unstable/price_rules/507328175.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/unstable/price_rules/507328175.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/price_rules/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
