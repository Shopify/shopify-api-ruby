...
class ResourceFeedbackUnstableTest < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/resource_feedback.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/resource_feedback.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/resource_feedback.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/unstable/resource_feedback.json")
  end
