...
class FulfillmentUnstableTest < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments.json?since_id=255858046")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments.json?since_id=255858046")
  end
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments.json")
  end
  ...
  def test_15()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/fulfillment_orders/1046000859/fulfillments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/unstable/fulfillment_orders/1046000859/fulfillments.json")
  end
  ...
  def test_16()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/count.json")
  end
  ...
  def test_17()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046.json")
  end
  ...
  def test_18()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046.json")
  end
  ...
  def test_19()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/fulfillments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/fulfillments.json")
  end
  ...
  def test_21()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/fulfillments/1069019908/update_tracking.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/fulfillments/1069019908/update_tracking.json")
  end
  ...
  def test_22()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046/complete.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046/complete.json")
  end
  ...
  def test_23()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046/open.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046/open.json")
  end
  ...
  def test_24()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046/cancel.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/orders/450789469/fulfillments/255858046/cancel.json")
  end
  ...
  def test_25()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/unstable/fulfillments/1069019909/cancel.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/unstable/fulfillments/1069019909/cancel.json")
  end
