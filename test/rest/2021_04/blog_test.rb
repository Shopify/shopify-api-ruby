...
class Blog202104Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-04/blogs.json")
      ...
      .to_return(status: 200, body: JSON.generate({"blog" => {"id" => 1008414259, "handle" => "apple-main-blog", "title" => "Apple main blog", "updated_at" => "2022-02-03T17:15:56-05:00", "commentable" => "no", "feedburner" => nil, "feedburner_location" => nil, "created_at" => "2022-02-03T17:15:56-05:00", "template_suffix" => nil, "tags" => "", "admin_graphql_api_id" => "gid://shopify/OnlineStoreBlog/1008414259"}}), headers: {})
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-04/blogs.json")
      ...
      .to_return(status: 200, body: JSON.generate({"blog" => {"id" => 1008414260, "handle" => "apple-main-blog", "title" => "Apple main blog", "updated_at" => "2022-02-03T17:15:59-05:00", "commentable" => "no", "feedburner" => nil, "feedburner_location" => nil, "created_at" => "2022-02-03T17:15:59-05:00", "template_suffix" => nil, "tags" => "", "admin_graphql_api_id" => "gid://shopify/OnlineStoreBlog/1008414260"}}), headers: {})
