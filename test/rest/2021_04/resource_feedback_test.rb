...
class ResourceFeedback202104Test < Test::Unit::TestCase
  ...
  def test_1()
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-04/resource_feedback.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-04/resource_feedback.json")
      .with(
