...
class Metafield202104Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-04/metafields.json")
      ...
      .to_return(status: 200, body: JSON.generate({"metafields" => [{"id" => 721389482, "namespace" => "affiliates", "key" => "app_key", "value" => "app_key", "value_type" => "string", "description" => nil, "owner_id" => 548380009, "created_at" => "2022-02-03T16:53:36-05:00", "updated_at" => "2022-02-03T16:53:36-05:00", "owner_resource" => "shop", "admin_graphql_api_id" => "gid://shopify/Metafield/721389482"}]}), headers: {})
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-04/metafields.json?since_id=721389482")
      ...
      .to_return(status: 200, body: JSON.generate({"metafields" => [{"id" => 1063298240, "namespace" => "inventory", "key" => "warehouse", "value" => 25, "value_type" => "integer", "description" => nil, "owner_id" => 548380009, "created_at" => "2022-02-03T17:01:00-05:00", "updated_at" => "2022-02-03T17:01:00-05:00", "owner_resource" => "shop", "admin_graphql_api_id" => "gid://shopify/Metafield/1063298240"}]}), headers: {})
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-04/metafields.json")
      ...
      .to_return(status: 200, body: JSON.generate({"metafield" => {"id" => 1063298242, "namespace" => "inventory", "key" => "warehouse", "value" => 25, "value_type" => "integer", "description" => nil, "owner_id" => 548380009, "created_at" => "2022-02-03T17:01:19-05:00", "updated_at" => "2022-02-03T17:01:19-05:00", "owner_resource" => "shop", "admin_graphql_api_id" => "gid://shopify/Metafield/1063298242"}}), headers: {})
  ...
  def test_7()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-04/metafields/721389482.json")
      ...
      .to_return(status: 200, body: JSON.generate({"metafield" => {"value" => "something new", "value_type" => "string", "namespace" => "affiliates", "key" => "app_key", "id" => 721389482, "description" => nil, "owner_id" => 548380009, "created_at" => "2022-02-03T16:53:36-05:00", "updated_at" => "2022-02-03T17:01:29-05:00", "owner_resource" => "shop", "admin_graphql_api_id" => "gid://shopify/Metafield/721389482"}}), headers: {})
