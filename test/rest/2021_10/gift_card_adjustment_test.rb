...
class GiftCardAdjustment202110Test < Test::Unit::TestCase
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/gift_cards/1035197676/adjustments/9.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-10/gift_cards/1035197676/adjustments/9.json")
  end
