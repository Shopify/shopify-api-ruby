...
class FulfillmentOrder202110Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000847.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000847.json")
  end
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000848/cancel.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000848/cancel.json")
  end
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000851/close.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000851/close.json")
  end
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000852/move.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000852/move.json")
  end
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000854/open.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000854/open.json")
  end
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000855/reschedule.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000855/reschedule.json")
  end
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000856/hold.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
      ...
      .to_return(status: 200, body: JSON.generate({"fulfillment_order" => {"id" => 1046000856, "shop_id" => 548380009, "order_id" => 450789469, "assigned_location_id" => 24826418, "request_status" => "unsubmitted", "status" => "on_hold", "supported_actions" => ["release_hold"], "destination" => {"id" => 1046000843, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "company" => nil, "country" => "United States", "email" => "bob.norman@hostmail.com", "first_name" => "Bob", "last_name" => "Norman", "phone" => "555-625-1199", "province" => "Kentucky", "zip" => "40202"}, "line_items" => [{"id" => 1058737603, "shop_id" => 548380009, "fulfillment_order_id" => 1046000856, "quantity" => 1, "line_item_id" => 518995019, "inventory_item_id" => 49148385, "fulfillable_quantity" => 1, "variant_id" => 49148385}], "fulfill_at" => nil, "international_duties" => {"incoterm" => "DAP"}, "fulfillment_holds" => [{"reason" => "inventory_out_of_stock", "reason_notes" => "Not enough inventory to complete this work."}], "delivery_method" => nil, "assigned_location" => {"address1" => nil, "address2" => nil, "city" => nil, "country_code" => "DE", "location_id" => 24826418, "name" => "Apple Api Shipwire", "phone" => nil, "province" => nil, "zip" => nil}, "merchant_requests" => []}}), headers: {})
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000856/hold.json")
  end
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000858/release_hold.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"fulfillment_order" => {"id" => 1046000858, "shop_id" => 548380009, "order_id" => 450789469, "assigned_location_id" => 24826418, "request_status" => "submitted", "status" => "open", "supported_actions" => ["cancel_fulfillment_order"], "destination" => {"id" => 1046000845, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "company" => nil, "country" => "United States", "email" => "bob.norman@hostmail.com", "first_name" => "Bob", "last_name" => "Norman", "phone" => "555-625-1199", "province" => "Kentucky", "zip" => "40202"}, "line_items" => [{"id" => 1058737605, "shop_id" => 548380009, "fulfillment_order_id" => 1046000858, "quantity" => 1, "line_item_id" => 518995019, "inventory_item_id" => 49148385, "fulfillable_quantity" => 1, "variant_id" => 49148385}], "fulfill_at" => "2022-02-03T17:09:59-05:00", "international_duties" => {"incoterm" => "DAP"}, "fulfillment_holds" => [], "delivery_method" => nil, "assigned_location" => {"address1" => nil, "address2" => nil, "city" => nil, "country_code" => "DE", "location_id" => 24826418, "name" => "Apple Api Shipwire", "phone" => nil, "province" => nil, "zip" => nil}, "merchant_requests" => []}}), headers: {})

    fulfillment_order = ShopifyAPI::FulfillmentOrder.new
    fulfillment_order.id = 1046000858
    fulfillment_order.release_hold()

    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000858/release_hold.json")
  end
