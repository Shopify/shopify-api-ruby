...
class CustomerSavedSearch202110Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches.json")
      .with(
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches.json?since_id=20610973")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches.json?since_id=20610973")
  end
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches.json")
  end
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/count.json?since_id=20610973")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/count.json?since_id=20610973")
  end
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109.json")
  end
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109.json")
  end
  ...
  def test_9()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109/customers.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-10/customer_saved_searches/789629109/customers.json")
  end
