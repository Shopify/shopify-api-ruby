...
class Fulfillment202110Test < Test::Unit::TestCase
  ...
  def test_15()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000859/fulfillments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillment_orders/1046000859/fulfillments.json")
  end
  ...
  def test_21()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillments/1069019908/update_tracking.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillments/1069019908/update_tracking.json")
  end
  ...
  def test_25()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillments/1069019909/cancel.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-10/fulfillments/1069019909/cancel.json")
  end
