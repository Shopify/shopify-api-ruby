...
class CustomCollection202110Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections.json?since_id=841564295")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collections" => [{"id" => 1063001357, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-04-05T13:26:23-04:00", "body_html" => nil, "published_at" => "2022-04-05T13:26:23-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001357"}]}), headers: {})
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001363, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-04-05T13:26:43-04:00", "body_html" => nil, "published_at" => "2022-04-05T13:26:43-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001363"}}), headers: {})
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001364, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-04-05T13:26:44-04:00", "body_html" => nil, "published_at" => nil, "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001364"}}), headers: {})
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001365, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-04-05T13:26:45-04:00", "body_html" => nil, "published_at" => "2022-04-05T13:26:45-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001365", "image" => {"created_at" => "2022-04-05T13:26:45-04:00", "alt" => "Rails Logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20220405-102247-sbeh2k.gif?v=1649179605"}}}), headers: {})
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001366, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2022-04-05T13:26:48-04:00", "body_html" => nil, "published_at" => "2022-04-05T13:26:48-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001366"}}), headers: {})
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001367, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-04-05T13:26:50-04:00", "body_html" => nil, "published_at" => "2022-04-05T13:26:50-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001367"}}), headers: {})
  ...
  def test_12()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 841564295, "handle" => "ipods", "title" => "IPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "products_count" => 1, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-04-05T13:17:47-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1649179067"}}}), headers: {})
  ...
  def test_13()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>5000 songs in your pocket</p>", "title" => "IPods", "handle" => "ipods", "id" => 841564295, "updated_at" => "2022-04-05T13:27:05-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-04-05T13:17:47-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1649179067"}}}), headers: {})
  ...
  def test_14()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2022-04-05T13:27:07-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-04-05T13:17:47-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1649179067"}}}), headers: {})
  ...
  def test_15()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => "2022-04-05T13:27:08-04:00", "updated_at" => "2022-04-05T13:27:08-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-04-05T13:17:47-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1649179067"}}}), headers: {})
  ...
  def test_16()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => nil, "updated_at" => "2022-04-05T13:27:09-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-04-05T13:17:47-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1649179067"}}}), headers: {})
  ...
  def test_17()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2022-04-05T13:27:11-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-04-05T13:27:11-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1649179631"}}}), headers: {})
  ...
  def test_18()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2022-04-05T13:27:14-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"alt" => "Rails logo", "created_at" => "2022-04-05T13:27:13-04:00", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20220405-102247-6csk4f.gif?v=1649179634"}}}), headers: {})
  ...
  def test_19()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "custom_collection" => hash_including({"image" => "", "updated_at" => "2022-04-05T13:27:15-04:00", "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}) }
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>The best selling ipod ever</p>", "handle" => "ipods", "updated_at" => "2022-04-05T13:27:16-04:00", "id" => 841564295, "sort_order" => "manual", "title" => "IPods", "template_suffix" => nil, "published_at" => "2008-02-01T19:00:00-05:00", "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}}), headers: {})
  ...
  def test_20()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-10/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2022-04-05T13:27:17-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-04-05T13:17:47-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1649179067"}}}), headers: {})
