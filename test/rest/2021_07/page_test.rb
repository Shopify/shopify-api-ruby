...
class Page202107Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-07/pages.json")
      ...
      .to_return(status: 200, body: JSON.generate({"page" => {"id" => 1025371372, "title" => "Warranty information", "shop_id" => 548380009, "handle" => "warranty-information", "body_html" => "<h2>Warranty</h2>\n<p>Returns accepted if we receive items <strong>30 days after purchase</strong>.</p>", "author" => "Shopify API", "created_at" => "2022-02-08T14:49:34-05:00", "updated_at" => "2022-02-08T14:49:34-05:00", "published_at" => "2022-02-08T14:49:34-05:00", "template_suffix" => nil, "admin_graphql_api_id" => "gid://shopify/OnlineStorePage/1025371372"}}), headers: {})
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-07/pages.json")
      ...
      .to_return(status: 200, body: JSON.generate({"page" => {"id" => 1025371373, "title" => "Warranty information", "shop_id" => 548380009, "handle" => "warranty-information", "body_html" => "<h2>Warranty</h2>\n<p>Returns accepted if we receive items <strong>30 days after purchase</strong>.</p>", "author" => "Shopify API", "created_at" => "2022-02-08T14:49:36-05:00", "updated_at" => "2022-02-08T14:49:36-05:00", "published_at" => nil, "template_suffix" => nil, "admin_graphql_api_id" => "gid://shopify/OnlineStorePage/1025371373"}}), headers: {})
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-07/pages.json")
      ...
      .to_return(status: 200, body: JSON.generate({"page" => {"id" => 1025371374, "title" => "Warranty information", "shop_id" => 548380009, "handle" => "warranty-information", "body_html" => "<h2>Warranty</h2>\n<p>Returns accepted if we receive items <strong>30 days after purchase</strong>.</p>", "author" => "Shopify API", "created_at" => "2022-02-08T14:49:39-05:00", "updated_at" => "2022-02-08T14:49:39-05:00", "published_at" => "2022-02-08T14:49:39-05:00", "template_suffix" => nil, "admin_graphql_api_id" => "gid://shopify/OnlineStorePage/1025371374"}}), headers: {})
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-07/pages/131092082.json")
      ...
      .to_return(status: 200, body: JSON.generate({"page" => {"shop_id" => 548380009, "body_html" => "<p>Returns accepted if we receive the items 14 days after purchase.</p>", "title" => "Terms of Services", "handle" => "tos", "id" => 131092082, "author" => "Dennis", "created_at" => "2008-07-15T20:00:00-04:00", "updated_at" => "2022-02-08T14:49:48-05:00", "published_at" => "2008-07-15T20:00:00-04:00", "template_suffix" => nil, "admin_graphql_api_id" => "gid://shopify/OnlineStorePage/131092082"}}), headers: {})
  ...
  def test_10()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2021-07/pages/131092082.json")
      ...
      .to_return(status: 200, body: JSON.generate({"page" => {"shop_id" => 548380009, "published_at" => "2022-02-08T14:49:51-05:00", "title" => "Terms of Services", "handle" => "tos", "body_html" => "<p>We make <strong>perfect</strong> stuff, we don't need a warranty.</p>", "id" => 131092082, "author" => "Dennis", "created_at" => "2008-07-15T20:00:00-04:00", "updated_at" => "2022-02-08T14:49:51-05:00", "template_suffix" => nil, "admin_graphql_api_id" => "gid://shopify/OnlineStorePage/131092082"}}), headers: {})
