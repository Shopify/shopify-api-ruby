...
class LocationsForMove202107Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000833/locations_for_move.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000833/locations_for_move.json")
  end
