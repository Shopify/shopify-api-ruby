...
class LocationsForMove202310Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-10/fulfillment_orders/1046000780/locations_for_move.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-10/fulfillment_orders/1046000780/locations_for_move.json")
