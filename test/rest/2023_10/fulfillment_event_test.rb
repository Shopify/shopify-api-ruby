...
class FulfillmentEvent202310Test < Test::Unit::TestCase
  ...
  def test_4()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-10/orders/450789469/fulfillments/255858046/events/944956391.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-10/orders/450789469/fulfillments/255858046/events/944956391.json")
