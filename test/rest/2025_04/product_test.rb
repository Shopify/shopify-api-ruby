...
class Product202504Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?since_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?since_id=632910392")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?collection_id=841564295")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?collection_id=841564295")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?presentment_currencies=USD")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?presentment_currencies=USD")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?fields=id%2Cimages%2Ctitle")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products.json?fields=id%2Cimages%2Ctitle")
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/count.json")
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/count.json?collection_id=841564295")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/count.json?collection_id=841564295")
  ...
  def test_9()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json?fields=id%2Cimages%2Ctitle")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json?fields=id%2Cimages%2Ctitle")
  ...
  def test_11()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
  ...
  def test_12()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 632910392, "title" => "IPod Nano - 8GB", "body_html" => "<p>It's the small iPod with one very big idea: Video. Now the world's most popular music player, available in 4GB and 8GB models, lets you enjoy TV shows, movies, video podcasts, and more. The larger, brighter display means amazing picture quality. In six eye-catching colors, iPod nano is stunning all around. And with models starting at just $149, little speaks volumes.</p>", "vendor" => "Apple", "product_type" => "Cult Products", "created_at" => "2025-04-02T11:29:59-05:00", "handle" => "ipod-nano", "updated_at" => "2025-04-02T11:36:09-05:00", "published_at" => nil, "template_suffix" => nil, "published_scope" => "web", "tags" => "Emotive, Flash Memory, MP3, Music", "status" => "active", "admin_graphql_api_id" => "gid://shopify/Product/632910392", "variants" => [{"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "199.00", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_pink", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008PINK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810", "image_id" => 562641783}, {"id" => 49148385, "product_id" => 632910392, "title" => "Red", "price" => "199.00", "position" => 2, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Red", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_red", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008RED", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 49148385, "inventory_quantity" => 20, "old_inventory_quantity" => 20, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/49148385", "image_id" => nil}, {"id" => 39072856, "product_id" => 632910392, "title" => "Green", "price" => "199.00", "position" => 3, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Green", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_green", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008GREEN", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 39072856, "inventory_quantity" => 30, "old_inventory_quantity" => 30, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/39072856", "image_id" => nil}, {"id" => 457924702, "product_id" => 632910392, "title" => "Black", "price" => "199.00", "position" => 4, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Black", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_black", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008BLACK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 457924702, "inventory_quantity" => 40, "old_inventory_quantity" => 40, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/457924702", "image_id" => nil}], "options" => [{"id" => 594680422, "product_id" => 632910392, "name" => "Color", "position" => 1, "values" => ["Pink", "Red", "Green", "Black"]}], "images" => [{"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}, {"id" => 562641783, "alt" => nil, "position" => 2, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1071517486", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano-2.png?v=1735835399", "variant_ids" => [808950810]}, {"id" => 378407906, "alt" => nil, "position" => 3, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/220090436", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}], "image" => {"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}}}), headers: {})
  ...
  def test_14()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 632910392, "title" => "Updated Product Title", "body_html" => "<p>It's the small iPod with one very big idea: Video. Now the world's most popular music player, available in 4GB and 8GB models, lets you enjoy TV shows, movies, video podcasts, and more. The larger, brighter display means amazing picture quality. In six eye-catching colors, iPod nano is stunning all around. And with models starting at just $149, little speaks volumes.</p>", "vendor" => "Apple", "product_type" => "Cult Products", "created_at" => "2025-04-02T11:29:59-05:00", "handle" => "ipod-nano", "updated_at" => "2025-04-02T11:36:40-05:00", "published_at" => "2007-12-31T19:00:00-05:00", "template_suffix" => nil, "published_scope" => "web", "tags" => "Emotive, Flash Memory, MP3, Music", "status" => "active", "admin_graphql_api_id" => "gid://shopify/Product/632910392", "variants" => [{"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "2000.00", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:36:40-05:00", "taxable" => true, "barcode" => "1234_pink", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "Updating the Product SKU", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "2000.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810", "image_id" => 562641783}, {"id" => 49148385, "product_id" => 632910392, "title" => "Red", "price" => "199.00", "position" => 2, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Red", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_red", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008RED", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 49148385, "inventory_quantity" => 20, "old_inventory_quantity" => 20, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/49148385", "image_id" => nil}, {"id" => 39072856, "product_id" => 632910392, "title" => "Green", "price" => "199.00", "position" => 3, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Green", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_green", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008GREEN", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 39072856, "inventory_quantity" => 30, "old_inventory_quantity" => 30, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/39072856", "image_id" => nil}, {"id" => 457924702, "product_id" => 632910392, "title" => "Black", "price" => "199.00", "position" => 4, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Black", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_black", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008BLACK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 457924702, "inventory_quantity" => 40, "old_inventory_quantity" => 40, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/457924702", "image_id" => nil}], "options" => [{"id" => 594680422, "product_id" => 632910392, "name" => "Color", "position" => 1, "values" => ["Pink", "Red", "Green", "Black"]}], "images" => [{"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}, {"id" => 562641783, "alt" => nil, "position" => 2, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1071517486", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano-2.png?v=1735835399", "variant_ids" => [808950810]}, {"id" => 378407906, "alt" => nil, "position" => 3, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/220090436", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}], "image" => {"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}}}), headers: {})
  ...
  def test_18()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 632910392, "title" => "IPod Nano - 8GB", "body_html" => "<p>It's the small iPod with one very big idea: Video. Now the world's most popular music player, available in 4GB and 8GB models, lets you enjoy TV shows, movies, video podcasts, and more. The larger, brighter display means amazing picture quality. In six eye-catching colors, iPod nano is stunning all around. And with models starting at just $149, little speaks volumes.</p>", "vendor" => "Apple", "product_type" => "Cult Products", "created_at" => "2025-04-02T11:29:59-05:00", "handle" => "ipod-nano", "updated_at" => "2025-04-02T11:36:38-05:00", "published_at" => "2007-12-31T19:00:00-05:00", "template_suffix" => nil, "published_scope" => "web", "tags" => "Emotive, Flash Memory, MP3, Music", "status" => "active", "admin_graphql_api_id" => "gid://shopify/Product/632910392", "variants" => [{"id" => 457924702, "product_id" => 632910392, "title" => "Black", "price" => "199.00", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Black", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:36:38-05:00", "taxable" => true, "barcode" => "1234_black", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008BLACK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 457924702, "inventory_quantity" => 40, "old_inventory_quantity" => 40, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/457924702", "image_id" => nil}, {"id" => 39072856, "product_id" => 632910392, "title" => "Green", "price" => "199.00", "position" => 2, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Green", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:36:38-05:00", "taxable" => true, "barcode" => "1234_green", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008GREEN", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 39072856, "inventory_quantity" => 30, "old_inventory_quantity" => 30, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/39072856", "image_id" => nil}, {"id" => 49148385, "product_id" => 632910392, "title" => "Red", "price" => "199.00", "position" => 3, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Red", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:36:38-05:00", "taxable" => true, "barcode" => "1234_red", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008RED", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 49148385, "inventory_quantity" => 20, "old_inventory_quantity" => 20, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/49148385", "image_id" => nil}, {"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "199.00", "position" => 4, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:36:38-05:00", "taxable" => true, "barcode" => "1234_pink", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008PINK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810", "image_id" => 562641783}], "options" => [{"id" => 594680422, "product_id" => 632910392, "name" => "Color", "position" => 1, "values" => ["Black", "Green", "Red", "Pink"]}], "images" => [{"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}, {"id" => 562641783, "alt" => nil, "position" => 2, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1071517486", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano-2.png?v=1735835399", "variant_ids" => [808950810]}, {"id" => 378407906, "alt" => nil, "position" => 3, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/220090436", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}], "image" => {"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}}}), headers: {})
  ...
  def test_20()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 632910392, "title" => "IPod Nano - 8GB", "body_html" => "<p>It's the small iPod with one very big idea: Video. Now the world's most popular music player, available in 4GB and 8GB models, lets you enjoy TV shows, movies, video podcasts, and more. The larger, brighter display means amazing picture quality. In six eye-catching colors, iPod nano is stunning all around. And with models starting at just $149, little speaks volumes.</p>", "vendor" => "Apple", "product_type" => "Cult Products", "created_at" => "2025-04-02T11:29:59-05:00", "handle" => "ipod-nano", "updated_at" => "2025-04-02T11:36:49-05:00", "published_at" => nil, "template_suffix" => nil, "published_scope" => "web", "tags" => "Emotive, Flash Memory, MP3, Music", "status" => "draft", "admin_graphql_api_id" => "gid://shopify/Product/632910392", "variants" => [{"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "199.00", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_pink", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008PINK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810", "image_id" => 562641783}, {"id" => 49148385, "product_id" => 632910392, "title" => "Red", "price" => "199.00", "position" => 2, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Red", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_red", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008RED", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 49148385, "inventory_quantity" => 20, "old_inventory_quantity" => 20, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/49148385", "image_id" => nil}, {"id" => 39072856, "product_id" => 632910392, "title" => "Green", "price" => "199.00", "position" => 3, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Green", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_green", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008GREEN", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 39072856, "inventory_quantity" => 30, "old_inventory_quantity" => 30, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/39072856", "image_id" => nil}, {"id" => 457924702, "product_id" => 632910392, "title" => "Black", "price" => "199.00", "position" => 4, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Black", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "taxable" => true, "barcode" => "1234_black", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008BLACK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 457924702, "inventory_quantity" => 40, "old_inventory_quantity" => 40, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/457924702", "image_id" => nil}], "options" => [{"id" => 594680422, "product_id" => 632910392, "name" => "Color", "position" => 1, "values" => ["Pink", "Red", "Green", "Black"]}], "images" => [{"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}, {"id" => 562641783, "alt" => nil, "position" => 2, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1071517486", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano-2.png?v=1735835399", "variant_ids" => [808950810]}, {"id" => 378407906, "alt" => nil, "position" => 3, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/220090436", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}], "image" => {"id" => 850703190, "alt" => nil, "position" => 1, "product_id" => 632910392, "created_at" => "2025-04-02T11:29:59-05:00", "updated_at" => "2025-04-02T11:29:59-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/498048120", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/products/ipod-nano.png?v=1735835399", "variant_ids" => []}}}), headers: {})
  ...
  def test_23()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2025-04/products/632910392.json")
  ...
  def test_24()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2025-04/products.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 1072481050, "title" => "Burton Custom Freestyle 151", "body_html" => "<strong>Good snowboard!</strong>", "vendor" => "Burton", "product_type" => "Snowboard", "created_at" => "2025-04-02T11:36:28-05:00", "handle" => "burton-custom-freestyle-151", "updated_at" => "2025-04-02T11:36:28-05:00", "published_at" => nil, "template_suffix" => nil, "published_scope" => "web", "tags" => "", "status" => "draft", "admin_graphql_api_id" => "gid://shopify/Product/1072481050", "variants" => [{"id" => 1070325028, "product_id" => 1072481050, "title" => "Default Title", "price" => "0.00", "position" => 1, "inventory_policy" => "deny", "compare_at_price" => nil, "option1" => "Default Title", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:36:28-05:00", "updated_at" => "2025-04-02T11:36:28-05:00", "taxable" => true, "barcode" => nil, "fulfillment_service" => "manual", "grams" => 0, "inventory_management" => nil, "requires_shipping" => true, "sku" => "", "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325028, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "0.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325028", "image_id" => nil}], "options" => [{"id" => 1064576492, "product_id" => 1072481050, "name" => "Title", "position" => 1, "values" => ["Default Title"]}], "images" => [], "image" => nil}}), headers: {})
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2025-04/products.json")
  ...
  def test_28()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2025-04/products.json")
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 1072481042, "title" => "Burton Custom Freestyle 151", "body_html" => "<strong>Good snowboard!</strong>", "vendor" => "Burton", "product_type" => "Snowboard", "created_at" => "2025-04-02T11:35:54-05:00", "handle" => "burton-custom-freestyle-151", "updated_at" => "2025-04-02T11:35:54-05:00", "published_at" => "2025-04-02T11:35:54-05:00", "template_suffix" => nil, "published_scope" => "global", "tags" => "", "status" => "active", "admin_graphql_api_id" => "gid://shopify/Product/1072481042", "variants" => [{"id" => 1070325019, "product_id" => 1072481042, "title" => "Default Title", "price" => "0.00", "position" => 1, "inventory_policy" => "deny", "compare_at_price" => nil, "option1" => "Default Title", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:35:54-05:00", "updated_at" => "2025-04-02T11:35:54-05:00", "taxable" => true, "barcode" => nil, "fulfillment_service" => "manual", "grams" => 0, "inventory_management" => nil, "requires_shipping" => true, "sku" => "", "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325019, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "0.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325019", "image_id" => nil}], "options" => [{"id" => 1064576483, "product_id" => 1072481042, "name" => "Title", "position" => 1, "values" => ["Default Title"]}], "images" => [{"id" => 1001473907, "alt" => nil, "position" => 1, "product_id" => 1072481042, "created_at" => "2025-04-02T11:35:54-05:00", "updated_at" => "2025-04-02T11:35:54-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1072273204", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/files/rails_logo20250402-63224-bpqtol.gif?v=1735835754", "variant_ids" => []}], "image" => {"id" => 1001473907, "alt" => nil, "position" => 1, "product_id" => 1072481042, "created_at" => "2025-04-02T11:35:54-05:00", "updated_at" => "2025-04-02T11:35:54-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1072273204", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/files/rails_logo20250402-63224-bpqtol.gif?v=1735835754", "variant_ids" => []}}}), headers: {})
  ...
  def test_29()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2025-04/products.json")
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 1072481047, "title" => "Burton Custom Freestyle 151", "body_html" => "<strong>Good snowboard!</strong>", "vendor" => "Burton", "product_type" => "Snowboard", "created_at" => "2025-04-02T11:36:25-05:00", "handle" => "burton-custom-freestyle-151", "updated_at" => "2025-04-02T11:36:25-05:00", "published_at" => "2025-04-02T11:36:25-05:00", "template_suffix" => nil, "published_scope" => "global", "tags" => "", "status" => "active", "admin_graphql_api_id" => "gid://shopify/Product/1072481047", "variants" => [{"id" => 1070325024, "product_id" => 1072481047, "title" => "Default Title", "price" => "0.00", "position" => 1, "inventory_policy" => "deny", "compare_at_price" => nil, "option1" => "Default Title", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:36:25-05:00", "updated_at" => "2025-04-02T11:36:25-05:00", "taxable" => true, "barcode" => nil, "fulfillment_service" => "manual", "grams" => 0, "inventory_management" => nil, "requires_shipping" => true, "sku" => "", "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325024, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "0.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325024", "image_id" => nil}], "options" => [{"id" => 1064576489, "product_id" => 1072481047, "name" => "Title", "position" => 1, "values" => ["Default Title"]}], "images" => [{"id" => 1001473909, "alt" => nil, "position" => 1, "product_id" => 1072481047, "created_at" => "2025-04-02T11:36:25-05:00", "updated_at" => "2025-04-02T11:36:25-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1072273206", "width" => 1, "height" => 1, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/files/df3e567d6f16d040326c7a0ea29a4f41.gif?v=1735835785", "variant_ids" => []}], "image" => {"id" => 1001473909, "alt" => nil, "position" => 1, "product_id" => 1072481047, "created_at" => "2025-04-02T11:36:25-05:00", "updated_at" => "2025-04-02T11:36:25-05:00", "admin_graphql_api_id" => "gid://shopify/MediaImage/1072273206", "width" => 1, "height" => 1, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/files/df3e567d6f16d040326c7a0ea29a4f41.gif?v=1735835785", "variant_ids" => []}}}), headers: {})
  ...
  def test_30()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2025-04/products.json")
      ...
      .to_return(status: 200, body: JSON.generate({"product" => {"id" => 1072481045, "title" => "Burton Custom Freestyle 151", "body_html" => "<strong>Good snowboard!</strong>", "vendor" => "Burton", "product_type" => "Snowboard", "created_at" => "2025-04-02T11:36:11-05:00", "handle" => "burton-custom-freestyle-151", "updated_at" => "2025-04-02T11:36:12-05:00", "published_at" => nil, "template_suffix" => nil, "published_scope" => "global", "tags" => "", "status" => "active", "admin_graphql_api_id" => "gid://shopify/Product/1072481045", "variants" => [{"id" => 1070325021, "product_id" => 1072481045, "title" => "Default Title", "price" => "0.00", "position" => 1, "inventory_policy" => "deny", "compare_at_price" => nil, "option1" => "Default Title", "option2" => nil, "option3" => nil, "created_at" => "2025-04-02T11:36:12-05:00", "updated_at" => "2025-04-02T11:36:12-05:00", "taxable" => true, "barcode" => nil, "fulfillment_service" => "manual", "grams" => 0, "inventory_management" => nil, "requires_shipping" => true, "sku" => "", "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325021, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "0.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325021", "image_id" => nil}], "options" => [{"id" => 1064576487, "product_id" => 1072481045, "name" => "Title", "position" => 1, "values" => ["Default Title"]}], "images" => [], "image" => nil}}), headers: {})
