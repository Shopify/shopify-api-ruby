...
class AbandonedCheckout202504Test < Test::Unit::TestCase
  ...
  def test_2()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts.json?status=closed")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts.json?status=closed")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts.json?limit=1")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts.json?limit=1")
