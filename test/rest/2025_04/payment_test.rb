...
class Payment202504Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts/7yjf4v2we7gamku6a6h7tvm8h3mmvs4x/payments.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts/7yjf4v2we7gamku6a6h7tvm8h3mmvs4x/payments.json")
  ...
  def test_2()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-04/checkouts/7yjf4v2we7gamku6a6h7tvm8h3mmvs4x/payments/25428999.json")
