...
class Webhook202207Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/webhooks.json?since_id=901431826")
      ...
      .to_return(status: 200, body: JSON.generate({"webhooks" => [{"id" => 1014196360, "address" => "https://example.org/app_uninstalled", "topic" => "app/uninstalled", "created_at" => "2023-07-11T18:32:46-04:00", "updated_at" => "2023-07-11T18:32:46-04:00", "format" => "json", "fields" => [], "metafield_namespaces" => [], "api_version" => "unstable", "private_metafield_namespaces" => []}]}), headers: {})
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/webhooks.json")
      ...
      .to_return(status: 200, body: JSON.generate({"webhook" => {"id" => 8081650041, "address" => "pubsub://projectName:topicName", "topic" => "customers/update", "created_at" => "2023-07-11T18:42:21-04:00", "updated_at" => "2023-07-11T18:42:21-04:00", "format" => "json", "fields" => [], "metafield_namespaces" => [], "api_version" => "unstable", "private_metafield_namespaces" => []}}), headers: {})
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/webhooks.json")
      ...
      .to_return(status: 200, body: JSON.generate({"webhook" => {"id" => 8081650035, "address" => "arn:aws:events:us-east-1::event-source/aws.partner/shopify.com/755357713/example-event-source", "topic" => "customers/update", "created_at" => "2023-07-11T18:41:59-04:00", "updated_at" => "2023-07-11T18:41:59-04:00", "format" => "json", "fields" => [], "metafield_namespaces" => [], "api_version" => "unstable", "private_metafield_namespaces" => []}}), headers: {})
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/webhooks.json")
      ...
      .to_return(status: 200, body: JSON.generate({"webhook" => {"id" => 8081650013, "address" => "https://example.hostname.com/", "topic" => "orders/create", "created_at" => "2023-07-11T18:39:38-04:00", "updated_at" => "2023-07-11T18:39:38-04:00", "format" => "json", "fields" => ["id", "note"], "metafield_namespaces" => [], "api_version" => "unstable", "private_metafield_namespaces" => []}}), headers: {})
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/webhooks/4759306.json")
      ...
      .to_return(status: 200, body: JSON.generate({"webhook" => {"id" => 4759306, "address" => "https://apple.com", "topic" => "orders/create", "created_at" => "2023-07-11T18:32:46-04:00", "updated_at" => "2023-07-11T18:32:46-04:00", "format" => "json", "fields" => [], "metafield_namespaces" => [], "api_version" => "unstable", "private_metafield_namespaces" => []}}), headers: {})
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/webhooks/4759306.json")
      ...
      .to_return(status: 200, body: JSON.generate({"webhook" => {"id" => 4759306, "address" => "https://somewhere-else.com/", "topic" => "orders/create", "created_at" => "2023-07-11T18:32:46-04:00", "updated_at" => "2023-07-11T18:38:09-04:00", "format" => "json", "fields" => [], "metafield_namespaces" => [], "api_version" => "unstable", "private_metafield_namespaces" => []}}), headers: {})
