...
class Report202207Test < Test::Unit::TestCase
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/reports.json")
      ...
      .to_return(status: 200, body: JSON.generate({"report" => {"id" => 1016888664, "name" => "A new app report", "shopify_ql" => "SHOW total_sales BY order_id FROM sales SINCE -1m UNTIL today ORDER BY total_sales", "updated_at" => "2022-07-02T01:52:18-04:00", "category" => "custom_app_reports"}}), headers: {})
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/reports/517154478.json")
      ...
      .to_return(status: 200, body: JSON.generate({"report" => {"name" => "Changed Report Name", "shopify_ql" => "SHOW total_sales BY order_id FROM sales SINCE -12m UNTIL today ORDER BY total_sales", "id" => 517154478, "updated_at" => "2022-07-02T01:52:19-04:00", "category" => "custom_app_reports"}}), headers: {})
