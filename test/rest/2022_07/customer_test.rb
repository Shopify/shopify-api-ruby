...
class Customer202207Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers.json?ids=207119551%2C1073339465")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers.json?ids=207119551%2C1073339465")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers.json?updated_at_min=2023-02-01+14%3A53%3A15")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers.json?updated_at_min=2023-02-01+14%3A53%3A15")
  end
  ...
  def test_14()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "customer" => hash_including({"accepts_marketing" => true, "accepts_marketing_updated_at" => "2023-01-30T09:51:24-05:00", "marketing_opt_in_level" => "confirmed_opt_in"}) }
      )
  ...
  def test_26()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/count.json?updated_at_min=2023-02-01+14%3A47%3A31")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/count.json?updated_at_min=2023-02-01+14%3A47%3A31")
  end
  ...
  def test_27()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/count.json?created_at_min=2023-02-01+14%3A40%3A44")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/count.json?created_at_min=2023-02-01+14%3A40%3A44")
  end
