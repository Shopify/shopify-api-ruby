...
class FulfillmentService202207Test < Test::Unit::TestCase
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/fulfillment_services.json")
      ...
      .to_return(status: 200, body: JSON.generate({"fulfillment_service" => {"id" => 1061774524, "name" => "Jupiter Fulfillment", "email" => nil, "service_name" => "Jupiter Fulfillment", "handle" => "jupiter-fulfillment", "fulfillment_orders_opt_in" => true, "include_pending_stock" => false, "provider_id" => nil, "location_id" => 1072404579, "callback_url" => "http://google.com/", "tracking_support" => true, "inventory_management" => true, "admin_graphql_api_id" => "gid://shopify/ApiFulfillmentService/1061774524", "permits_sku_sharing" => true}}), headers: {})
