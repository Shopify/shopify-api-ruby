...
class MarketingEvent202207Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events.json")
      ...
      .to_return(status: 200, body: JSON.generate({"marketing_event" => {"id" => 1065859216, "event_type" => "ad", "remote_id" => nil, "started_at" => "2022-12-15T03:00:00-05:00", "ended_at" => nil, "scheduled_to_end_at" => nil, "budget" => nil, "currency" => nil, "manage_url" => nil, "preview_url" => nil, "utm_campaign" => "Christmas2022", "utm_source" => "facebook", "utm_medium" => "cpc", "budget_type" => nil, "description" => nil, "marketing_channel" => "social", "paid" => true, "referring_domain" => "facebook.com", "breadcrumb_id" => nil, "marketing_activity_id" => 1063897333, "admin_graphql_api_id" => "gid://shopify/MarketingEvent/1065859216", "marketed_resources" => []}}), headers: {})
