...
class CustomCollection202207Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json?since_id=841564295")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collections" => [{"id" => 1063001319, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-07-02T01:57:24-04:00", "body_html" => nil, "published_at" => "2022-07-02T01:57:24-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001319"}]}), headers: {})
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001325, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-07-02T01:57:40-04:00", "body_html" => nil, "published_at" => "2022-07-02T01:57:40-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001325"}}), headers: {})
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001326, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-07-02T01:57:42-04:00", "body_html" => nil, "published_at" => nil, "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001326"}}), headers: {})
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001327, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-07-02T01:57:45-04:00", "body_html" => nil, "published_at" => "2022-07-02T01:57:42-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001327", "image" => {"created_at" => "2022-07-02T01:57:44-04:00", "alt" => "Rails Logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20220701-47213-yd9nu2.gif?v=1656741465"}}}), headers: {})
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001328, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2022-07-02T01:57:48-04:00", "body_html" => nil, "published_at" => "2022-07-02T01:57:48-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001328"}}), headers: {})
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001329, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-07-02T01:57:49-04:00", "body_html" => nil, "published_at" => "2022-07-02T01:57:49-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001329"}}), headers: {})
  ...
  def test_12()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 841564295, "handle" => "ipods", "title" => "IPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "products_count" => 1, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-07-02T01:51:59-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1656741119"}}}), headers: {})
  ...
  def test_13()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2022-07-02T01:56:38-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-07-02T01:51:59-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1656741119"}}}), headers: {})
  ...
  def test_14()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => "2022-07-02T01:56:40-04:00", "updated_at" => "2022-07-02T01:56:40-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-07-02T01:51:59-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1656741119"}}}), headers: {})
  ...
  def test_15()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => nil, "updated_at" => "2022-07-02T01:56:41-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-07-02T01:51:59-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1656741119"}}}), headers: {})
  ...
  def test_16()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2022-07-02T01:56:46-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-07-02T01:56:46-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1656741406"}}}), headers: {})
  ...
  def test_17()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2022-07-02T01:56:51-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"alt" => "Rails logo", "created_at" => "2022-07-02T01:56:49-04:00", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20220701-47213-n8ff0s.gif?v=1656741411"}}}), headers: {})
  ...
  def test_18()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "custom_collection" => hash_including({"image" => "", "updated_at" => "2022-07-02T01:56:54-04:00", "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}) }
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>The best selling ipod ever</p>", "handle" => "ipods", "updated_at" => "2022-07-02T01:56:55-04:00", "id" => 841564295, "sort_order" => "manual", "title" => "IPods", "template_suffix" => nil, "published_at" => "2008-02-01T19:00:00-05:00", "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}}), headers: {})
  ...
  def test_19()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2022-07-02T01:56:56-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-07-02T01:51:59-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1656741119"}}}), headers: {})
  ...
  def test_20()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>5000 songs in your pocket</p>", "title" => "IPods", "handle" => "ipods", "id" => 841564295, "updated_at" => "2022-07-02T01:58:10-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-07-02T01:51:59-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1656741119"}}}), headers: {})
