...
class DeprecatedApiCall202507Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2025-07/deprecated_api_calls.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2025-07/deprecated_api_calls.json")
