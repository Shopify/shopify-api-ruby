...
module ShopifyAPI
  class CustomerAddress < ShopifyAPI::RestWrappers::Base
    extend T::Sig
    ...
    class << self
      ...
      def find(
        ...
        result = base_find(
          ids: {customer_id: customer_id, id: id},
          params: {},
          session: session,
        )
      ...
      def delete(
        ...
        request(
          ...
          operation: :delete,
          session: session,
          path_ids: {customer_id: customer_id, id: id},
          params: {},
        )
      end
